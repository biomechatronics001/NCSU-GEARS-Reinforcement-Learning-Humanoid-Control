...
* We can sum up discounted TD errors to form *generalized advantage* (GAE), similar to summing up discounted rewards to get total return. This process further reduces the variance. [[Lecture 6]](./lecture_slides/Lecture%206%20-%20Junxi%20-%20Actor%20Critic%20Method,%20Proximal%20Policy%20Optimization.pdf)
